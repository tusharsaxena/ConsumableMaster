...
--
-- The verbs held to what they leave in the store -- the #35 characterization,
-- the list-shaped rows, /cm lock and /cm unlock, /cm enable and /cm disable and
-- the disabled refusal -- were peeled out to tests/test_slash_store.lua for
-- layout-§1's 1000-1500 band (CM-ATS-02). Every case moved whole.
