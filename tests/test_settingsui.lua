...
--
-- The Macros page's own controls -- the category reset popup, the Add-by-ID line
-- and the #35 Stat Priority and composite writers -- were peeled out to
-- tests/test_settingsui_category.lua for layout-§1's 1000-1500 band
-- (CM-ATS-02). Every case moved whole.
