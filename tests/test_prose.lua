...
--
-- WHY IT EXISTS, in this repo specifically. `M4-13` swept 51 lines across 22 files against this very
-- list and left nothing behind to hold the line. Four commits later `M4-18`, `M4-21` and `M4-22` had
-- put 26 lines back, in files those three had every reason to touch: a colour decoder's test names, a
-- lexer's SPLIT COLOUR token, a debounce's `behaviour`. Nobody was careless. A sweep is a measurement
-- of one afternoon, and the only thing that makes it a property of the repository is a gate. This is
-- that gate, and its absence is the whole of what `M4c-02` was.
--
