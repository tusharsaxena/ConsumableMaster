...
-- (core/MacroBarModel.lua), display resolution (core/MacroDisplay.lua), cooldown
-- application, the Macro Bar page's schema rows, the flyout's candidate list
-- (MacroBarFlyout.Candidates, which is pure over Selector + config), click
-- gating, the addon-wide master controls and the page's Defaults button.
--
