...
Separately, the Macro Bar page's **Reset page** (`settings/MacroBar.lua:602`) replaces the whole `macroBar` table, schema rows included, without going through the helper. That is the schema-row MUST, not this list, and it is tracked in [#36](https://github.com/tusharsaxena/ConsumableMaster/issues/36).
