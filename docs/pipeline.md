...
event ──▶ bus:SendMessage(KCM.MSG.RECOMPUTE, reason)
          ...
          Recompute(reason)
            ...
            │             elseif cat.perHand:
            │                 mh = Selector.PickBestForSlot(cat.key, 16, scoreCache)
