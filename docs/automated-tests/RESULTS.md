...
**792 cases** — 792 passed, 0 failed, 0 skipped. The generated inventory
[`20260911-211045/test-cases.md`](20260911-211045/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **788 → 792** since the previous run.
...
[`20260911-211045/perf.json`](20260911-211045/perf.json).
...
Current as of [`20260911-211045`](20260911-211045/) — **this run's measurement, not its diff.** Max CCN **15** across 1966
