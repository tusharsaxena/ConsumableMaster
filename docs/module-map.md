...
core/LifecycleSetup.lua ── The addon's half of LibKa0s-Lifecycle-1.0: ONE
                   ...
                   one standUp. Loads SECOND in # Core, ahead of PerfSetup,
                   ...
                   standUp re-runs KCM:OnEnable and rebuilds from the
                   settings AS THEY ARE NOW. Absent major -> absent feature
